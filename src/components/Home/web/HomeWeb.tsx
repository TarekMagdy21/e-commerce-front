...
import {FaUser, FaBars, FaHeart, FaRegUserCircle, FaFacebookF, FaInstagram, FaYoutube, FaTwitter} from "react-icons/fa";
    ...
    <div className="max-md:hidden ">
        ...
        <div className=" relative">
          <div className="   bg-[#00A1F1]   bg-cover  bg-center  ">
            <img src={yellowDude} alt="" className="absolute right-0 " width={763} />
